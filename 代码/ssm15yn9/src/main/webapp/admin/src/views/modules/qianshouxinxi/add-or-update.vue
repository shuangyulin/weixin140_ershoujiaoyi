<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品状态" prop="shangpinzhuangtai">
          <el-input v-model="ruleForm.shangpinzhuangtai" 
              placeholder="商品状态" clearable  :readonly="ro.shangpinzhuangtai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品状态" prop="shangpinzhuangtai">
              <el-input v-model="ruleForm.shangpinzhuangtai" 
                placeholder="商品状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="送货时间" prop="songhuoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.songhuoshijian" 
                type="datetime"
                placeholder="送货时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.songhuoshijian" label="送货时间" prop="songhuoshijian">
              <el-input v-model="ruleForm.songhuoshijian" 
                placeholder="送货时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="收货时间" prop="shouhuoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.shouhuoshijian" 
                type="datetime"
                placeholder="收货时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shouhuoshijian" label="收货时间" prop="shouhuoshijian">
              <el-input v-model="ruleForm.shouhuoshijian" 
                placeholder="收货时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="快递公司" prop="kuaidigongsi">
          <el-input v-model="ruleForm.kuaidigongsi" 
              placeholder="快递公司" clearable  :readonly="ro.kuaidigongsi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="快递公司" prop="kuaidigongsi">
              <el-input v-model="ruleForm.kuaidigongsi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="快递单号" prop="kuaididanhao">
          <el-input v-model="ruleForm.kuaididanhao" 
              placeholder="快递单号" clearable  :readonly="ro.kuaididanhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="快递单号" prop="kuaididanhao">
              <el-input v-model="ruleForm.kuaididanhao" 
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qianshouxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qianshouxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
